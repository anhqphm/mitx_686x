...
def epsilon_greedy(state_1, state_2, q_func, epsilon):
    ...
    if C < epsilon:
        ...
        q_value = q_func[state_1, state_2, :, :]
        action_index, object_index = np.unravel_index(np.argmax(q_value, axis=None), q_value.shape)
...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    if terminal:
        ...
        q_nextstage = q_func[next_state_1, next_state_2, :, :]
        maxQ = np.max(q_nextstage)
